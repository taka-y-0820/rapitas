    ...
    ja: {
      ...
      implementer: {
        ...
        constraints:
          ...
          '- **Verification observation failure**: HTTP 429, HTTP 000, a client timeout, or a background-tool observation timeout does NOT prove that verification failed or ended. Do not poll run-verification with POST or start another verification to obtain status. Continue observing the original live tool handle when available. If its result cannot be recovered, report verification as unconfirmed and exit with the changes preserved; do not claim task completion. The three repair attempts above apply only to a received terminal result with ok:false, followed by an actual repair.\n' +
